...
def test_power_attribute():
    attack = MagicAttack(power=1, attack_range=2)

    assert hasattr(attack, "power"), f"MagicAttack should have a power attribute"

def test_power_is_set(power):
    attack = MagicAttack(power=power, attack_range=2)
...
def test_attack_range_attribute():
    ...
    assert hasattr(attack, "attack_range"), f"MagicAttack should have an attack_range attribute"

def test_attack_range_is_set(attack_range):
    attack = MagicAttack(power=1, attack_range=attack_range)
